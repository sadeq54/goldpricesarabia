...
export const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    body: {
      en: "The site is funded by advertising. That money never moves a published price and never buys editorial coverage — the rule is written into our editorial standards. Advertisers are third parties: what they offer is between you and them.",
      ar: "يُموَّل الموقع عبر الإعلانات. هذا المال لا يحرّك أبداً سعراً منشوراً ولا يشتري تغطية تحريرية — والقاعدة مكتوبة في معايير التحرير لدينا. المعلنون أطراف ثالثة: ما يعرضونه شأن بينك وبينهم.",
      fr: "Le site est financé par la publicité. Cet argent ne modifie jamais un prix publié ni n'achète de couverture éditoriale — la règle figure dans notre charte. Les annonceurs sont des tiers : leurs offres relèvent de vous et d'eux.",
      tr: "Site reklamlarla finanse edilir. Bu para yayımlanmış bir fiyatı asla değiştirmez ve editoryal içerik satın almaz — kural editoryal standartlarımızda yazılıdır. Reklamverenler üçüncü taraftır: sundukları sizinle onlar arasındadır.",
      ur: "سائٹ اشتہارات سے چلتی ہے۔ یہ رقم کبھی کسی شائع شدہ قیمت کو نہیں بدلتی اور نہ ادارتی کوریج خریدتی ہے — یہ اصول ہمارے ادارتی معیارات میں درج ہے۔ اشتہار دہندگان تھرڈ پارٹی ہیں: ان کی پیشکش آپ کے اور ان کے درمیان معاملہ ہے۔",
      hi: "साइट विज्ञापन से चलती है। यह पैसा किसी प्रकाशित भाव को कभी नहीं बदलता और न संपादकीय कवरेज ख़रीदता है — यह नियम हमारे संपादकीय मानकों में लिखा है। विज्ञापनदाता तृतीय पक्ष हैं: उनकी पेशकश आपके और उनके बीच है।",
    },
  },
  {
    h: {
